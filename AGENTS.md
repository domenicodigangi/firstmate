...
- `project-management` - load before adding, creating, removing, or initializing a project.
  Cloning or registering a project is add intake and uses the same trigger.
- `pr-description` - load before writing or rewriting a pull-request title or description.
...
- `wayfinder-intake` - load before intake, dispatch, resolution, or completion for a project whose planning lives as a decision-ticket map in its own repository or a dedicated tracker repository.
